...
export function PasswordResetTemplate({
	...
	return (
		<Html>
			<Head />
			<Preview>Reset your Stream password</Preview>
				...
				<Container style={styles.container}>
					...
					<Section style={styles.content}>
						...
						<Text style={styles.text}>
							We received a request to reset the password for your Stream
							account. If you made this request, click the button below.
						</Text>
						<Text style={styles.text}>
							This link will expire in <strong>15 minutes</strong>. If you
							don't reset your password within that time, you'll need to submit
							a new request.
						</Text>
					...
					<table style={styles.metaTable}>
						<tbody>
							...
							<tr>
								...
								<td style={styles.metaValue}>
									{metadata.device.browser} · {metadata.device.os} · {metadata.device.type}
								</td>
							</tr>
						</tbody>
					</table>
